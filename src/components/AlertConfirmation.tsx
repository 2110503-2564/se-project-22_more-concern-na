...
export default function AlertConfirmation({onOpen, onOpenChange, type, onConfirm, onCancel}: AlertConfirmationProps) {
  let titleText = '';
  let descriptionText = '';
  ...
  switch (type) {
    case 'delete':
      ...
      descriptionText = 'Are you sure you want to delete this? This action cannot be undone.'
