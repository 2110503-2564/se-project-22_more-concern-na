...
export default function CouponCard({id,
  name,
  point,
  discount,
  expire,
  ...
  return (
    <div className="flex w-full max-w-md rounded-lg overflow-hidden shadow-md bg-gray-900 text-black">
      ...
      <div className="flex flex-col justify-between bg-gray-200 text-black w-2/3 p-4">
        <div>
          <div className="text-lg font-detail font-semibold mb-2" data-testid="name">{name}</div>
          <div className="text-sm font-detail" data-testid="expire">Expires In: {expire}</div>
        </div>
        <div className="flex items-center justify-between mt-4">
          <div className="text-sm font-detail" data-testid="remain">{remain} Remaining</div>
