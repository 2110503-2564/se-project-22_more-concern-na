    ...
    <div className="w-[70%] bg-purple-400 rounded-lg shadow overflow-hidden">
      ...
      <div className="p-4">
        <div className='flex justify-between'>
            <h2 className="text-xl font-semibold text-gray-800">{room.roomType}</h2>
        ...
        <div className="mt-4 flex justify-between">
            <p className="mt-3 text-sm text-gray-600">{room.remainCount} rooms available</p>
          <Button variant="default" onClick={() => onSelectRoom(room)} className="bg-blue-600 ml-7 text-white text-sm px-8 py-2 rounded hover:bg-blue-700">
            Select Room
          </Button>
        </div>
      </div>
